...
Only for Models with Sky Segmentation like Mono or Metrix

![V2 output Style for V3](assets/TBG_V2_Style.png)

![V2 output Style for V3 node](assets/v2stylenode.png)

# ComfyUI Depth Anything V3 by PozzettiAndrea
